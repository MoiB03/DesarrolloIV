...
insert into Openings(o_img, o_lista, o_lista_texto, playlist, playlist_texto, gif)
			  values('https://github.com/MoiB03/DesarrolloIV/blob/main/Parcial%203/Pagina/img/mejores_openings.png?raw=true','https://www.youtube.com/watch?v=aJRu5ltxXjc&pp=ygURYmx1ZSBiaXJkIG9wZW5pbmc%3D','Blue Bird: Opening 3','https://www.youtube.com/watch?v=4t__wczfpRI&list=PLTGXZPSNXuQF0TugWpvhWbOAAKmyl4xVQ&ab_channel=CrunchyrollDeutschland','Ver lista de openings','https://github.com/MoiB03/DesarrolloIV/blob/main/Parcial%203/Pagina/img/naruto-bailando.gif?raw=true'),
